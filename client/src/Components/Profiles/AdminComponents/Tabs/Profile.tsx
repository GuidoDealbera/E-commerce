    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-gray-700 shadow-sm">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11">
          <div className="relative mx-auto -mt-[5.5rem] h-[7.5rem] w-full max-w-[7.5rem] rounded-full bg-white/20 backdrop-blur sm:h-44 sm:max-w-[11rem] sm:p-3">
            <div className="relative drop-shadow-sm">
              <img src={image} alt="perfil" className="rounded-full" />
              <label
                htmlFor="perfil"
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl">Guido José Dealbera</h3>
